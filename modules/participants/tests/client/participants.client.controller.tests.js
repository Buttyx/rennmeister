  ...
  describe('Participants Controller Tests', function () {
    ...
    describe('vm.save() as create', function () {
      ...
      beforeEach(function () {
        ...
        sampleParticipantPostData = new ParticipantsService({
          name: 'Participant Name'
        });

        $scope.vm.participant = sampleParticipantPostData;
      });

      it('should send a POST request with the form input values and then locate to new object URL', inject(function (ParticipantsService) {
        // Set POST response
        ...
        expect($state.go).toHaveBeenCalledWith('participants.view', {
          participantId: mockParticipant._id
        });
      }));
    ...
    describe('vm.save() as update', function () {
      beforeEach(function () {
        ...
        $scope.vm.participant = mockParticipant;
      });

      it('should update a valid Participant', inject(function (ParticipantsService) {
        // Set PUT response
      ...
      it('should set $scope.vm.error if error', inject(function (ParticipantsService) {
    ...
    describe('vm.remove()', function () {
      ...
      it('should delete the Participant and redirect to Participants', function () {
        ...
        expect($state.go).toHaveBeenCalledWith('participants.list');
      });

      it('should should not delete the Participant and not redirect', function () {
